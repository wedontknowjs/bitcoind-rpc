...
describe('RpcClient', function() {
  ...
  it('should callback with error if invalid json', function(done) {
    ...
    client.getDifficulty(function(error, parsedBuf) {
      requestStub.restore();
      should.exist(error);
      error.message.should.have.string('Bitcoin JSON-RPC: Error Parsing JSON: Unexpected token o');
      done();
    });
  ...
  it('should callback with error if blank response', function(done) {
    ...
    client.getDifficulty(function(error, parsedBuf) {
      requestStub.restore();
      should.exist(error);
      error.message.should.have.string('Bitcoin JSON-RPC: Error Parsing JSON: Unexpected end of');
      done();
    });
